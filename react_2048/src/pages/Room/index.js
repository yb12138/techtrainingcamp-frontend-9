...
export default class Room extends React.Component{
    ...
    render(){
      ...
      const inRomm=(!leve==0)?(<div style={{textAlign:'center'}}><Button onClick={()=>this.joinRoom(room.roomId)}>加入房间</Button></div>):(<div style={{textAlign:'center'}}><Button>围观</Button></div>)
